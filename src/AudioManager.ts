...
const SOUND_MANIFEST: Record<SoundKey, SoundDef> = {
  ...
  player_walk: {
    url: "/audio/player/walking.mp3",
    loop: true,
    volume: 0.45,
    spatial: false,
  },
  player_jump: {
    url: ["/audio/player/jump1.mp3", "/audio/player/jump2.mp3"],
    loop: false,
    volume: 0.6,
    spatial: false,
  },
  player_dash: {
    url: "/audio/player/dash.mp3",
    loop: false,
    volume: 0.5,
    spatial: false,
  },
  player_punch: {
    url: "/audio/player/punch.mp3",
    loop: false,
    volume: 0.7,
    spatial: false,
  },
  player_take_damage: {
    url: "/audio/player/takeDamage.mp3",
    loop: false,
    volume: 0.8,
    spatial: false,
  },
  ...
  weapon_shoot: {
    url: "/audio/weapons/assault-rifle/assault-rifle-shot.mp3",
    loop: false,
    volume: 0.8,
    spatial: false,
  },
  weapon_reload: {
    url: "/audio/weapons/assault-rifle/assault-rifle-reload.mp3",
    loop: false,
    volume: 0.6,
    spatial: false,
  },
  ...
  enemy_attack: {
    url: "/audio/enemy/attack.mp3",
    loop: false,
    volume: 0.7,
    spatial: false,
  },
  enemy_hit: {
    url: ["/audio/enemy/enemy-hit1.mp3", "/audio/enemy/enemy-hit2.mp3"],
    loop: false,
    volume: 0.6,
    spatial: false,
  },
  enemy_death: {
    url: "/audio/enemy/death.mp3",
    loop: false,
    volume: 0.7,
    spatial: false,
  },
  enemy_alert: {
    url: [
      "/audio/enemy/enemy-alert1.mp3",
      "/audio/enemy/enemy-alert2.mp3",
      "/audio/enemy/enemy-alert3.mp3",
      "/audio/enemy/enemy-alert4.mp3",
    ],
    loop: false,
    volume: 0.5,
    spatial: false,
  ...
  // UI — no files yet
  ui_start: {
    url: "/audio/ui/start.mp3",
    loop: false,
    volume: 0.5,
    spatial: false,
  },
  ui_pause: {
    url: "/audio/ui/pause.mp3",
    loop: false,
    volume: 0.4,
    spatial: false,
  },
  ui_resume: {
    url: "/audio/ui/resume.mp3",
    loop: false,
    volume: 0.4,
    spatial: false,
  },
  ui_game_over: {
    url: "/audio/ui/game_over.mp3",
    loop: false,
    volume: 0.8,
    spatial: false,
  },
        ...
        await Promise.allSettled(
          urls.map(async (url, i) => {
            try {
              ...
              console.warn(
                `[AudioManager] Missing audio: "${key}" variant ${i} (${url})`,
              );
            }
          }),
        );
